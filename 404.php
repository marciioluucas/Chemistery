        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li><a href="admin/pages/errors/invoice.html"><i class="fa fa-circle-o"></i> Invoice</a></li>
                <li><a href="admin/pages/errors/profile.html"><i class="fa fa-circle-o"></i> Profile</a></li>
                <li><a href="admin/pages/errors/login.html"><i class="fa fa-circle-o"></i> Login</a></li>
                <li><a href="admin/pages/errors/register.html"><i class="fa fa-circle-o"></i> Register</a></li>
                <li><a href="admin/pages/errors/lockscreen.html"><i class="fa fa-circle-o"></i> Lockscreen</a></li>
                <li class="active"><a href="404.html"><i class="fa fa-circle-o"></i> 404 Error</a></li>
                <li><a href="admin/pages/errors/500.html"><i class="fa fa-circle-o"></i> 500 Error</a></li>
                <li><a href="admin/pages/errors/blank.html"><i class="fa fa-circle-o"></i> Blank Page</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
          ...
          <div class="error-page">
            ...
            <div class="error-content">
              ...
              <p>
                ...
                Meanwhile, you may <a href="view/index.php">return to dashboard</a> or try using the search form.
              </p>
