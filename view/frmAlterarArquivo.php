...
$arquivoController->consulta("uploads", "id = " . $_GET['id']);
$rUploads = mysqli_fetch_array($arquivoController->arquivo->query, MYSQLI_ASSOC);

$arquivoController->consulta("cliente", " id=" . $rUploads['cliente_id'] . " and ativado=1");
$rCliente = mysqli_fetch_array($arquivoController->arquivo->query, MYSQLI_ASSOC);
            ...
            <div class="box-body">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="arquivoIdentificacao" name="arquivoIdentificacao"
                               required
                               placeholder="Coloque aqui a identificação"
                               value="<?php echo $rUploads['identificador'] ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" style="margin-top: -3px !important;">
                            ...
                            <select class="form-control select2"
                               ...
                               echo $arquivoController->consultaClienteCadastrado($rCliente['id']);
                                $clienteController->consultaClientes() ?>
                            </select>
                        </div>
                    </div><!-- /.form-group -->
                </div>
