...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Alteração
            <small>de imagem padrão</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="">Produtos</li>
            <li class="">Imagem Padrão</li>
    ...
    <div>
        ...
        <form action="../controller/ConfSistemaController.php" method="post" enctype="multipart/form-data"
            ...
            <input type="text" name="question" id="question" value="alterarImagemPadrao" hidden="hidden"/>
            ...
            <div class="box-body">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="produtoImagemPadrao" name="produtoImagemPadrao">
                        <p class="help-block">Para melhor vizualização recomendamos imagens 256 x 256 ou maior e do formato .jpg
                            ou .png</p>
                        <div class="col-lg-3 text-center"><img src="../imagens/noimg.png" id="preview-da-imagem" width="190"
...
<script>
    ...
    $("#produtoImagemPadrao").change(function () {
        readURL(this);
    });
