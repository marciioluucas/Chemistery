            ...
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <div id="tipos">
                        ...
                        <div class="col-md-6"><label for="tipo1">Pessoa física</label><input type="radio" name="clienteTipo" required checked="checked"
                                                                          value="fisica" id="tipo1"
                                                                          class="minimal">
                        </div>

                        <div class="col-md-6"><label for="tipo2">Pessoa jurídica</label><input type="radio" name="clienteTipo" required
                                                                            value="juridica" id="tipo2"
                                                                            class="minimal">
                        </div>
...
<script>
    ...
    function limparcampos() {
        $('#frmCadastroCliente').each(function () {
            this.reset();
        });
    }
    ...
    $(function () {
        $('#tipo1').change(function () {
            $('#lblIdentificacao').html("CPF");
        });


        $('#tipo2').change(function () {
            $('#lblIdentificacao').html("CNPJ");
        });
