...
<body class="hold-transition skin-purple sidebar-mini" onload="data()">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-body text-center">
                                ...
                                <div class="col-xs-6 text-center">
                                    <a href="../controller/UsuarioController.php?p=deslogar&tela=usr"
                    ...
                    <li>
                        <a href="../controller/UsuarioController.php?p=deslogar&tela=usr"><i class="fa fa-sign-out"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
